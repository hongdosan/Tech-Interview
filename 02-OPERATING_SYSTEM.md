...
<details>
  ...
  - 다시 말해, PCB(혹은 TCB)를 기반으로 프로세스(혹은 스레드)를 저장하고 다시 복원하는 과정으로 한 프로세스에 할당된 시간이 끝나거나 프로세스가 종료되거나 인터럽트에 의해 발생합니다. 예를 들어, 할당 시간을 전부 사용한 타임아웃 혹은 I/O 요청에 의한 시스템 콜 등이 있습니다.
